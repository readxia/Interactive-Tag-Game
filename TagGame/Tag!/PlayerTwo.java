...
public class PlayerTwo extends Actor
{
    ...
    public void act() 
    {
        ...
        if(time<=0)
        {
            RedLose reed=new RedLose();
            Greenfoot.setWorld(reed);
        }
        //if(youareit.returnFarts()==1)
        //{
        //    it=true;
        //
    }    
    public PlayerTwo()
    {
        ...
        {
            runningFrames[i]=new GreenfootImage("red/"+i+".png");
        }
        runningFramesLeft=new GreenfootImage[8];
        for(int i=0;i<runningFramesLeft.length;i++)
        {
            runningFramesLeft[i]=new GreenfootImage("red/"+i+".png");
        ...
        idleFrames[0]=new GreenfootImage("red/0.png");
        currentFrame=0;
        notInsideBoost=true;
        notInsideSand=true;
        notInsideWater=true;
